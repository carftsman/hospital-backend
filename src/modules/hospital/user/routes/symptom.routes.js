 ...
 *     description: >
 *       Public API to fetch symptoms with optional search, pagination,
 *       women-specific filtering, and critical symptom filtering.
 *       No authentication token is required.
 *     tags:
 *       - Symptoms
 *     parameters:
 ...
 *           example: true
 *         required: false
 *         description: Return only women-specific symptoms
 *
 *       - in: query
 *         name: critical
 *         schema:
 ...
 *           example: true
 *         required: false
 *         description: Return only critical symptoms (e.g. emergency pregnancy symptoms)
 *
 *       - in: query
 *         name: page
 *         schema:
