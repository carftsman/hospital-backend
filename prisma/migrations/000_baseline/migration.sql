-- CreateEnum
CREATE TYPE "BookingFor" AS ENUM ('SELF', 'OTHER');

-- CreateEnum
CREATE TYPE "LabBookingStatus" AS ENUM ('PENDING', 'HOLD', 'CONFIRMED', 'SAMPLE_COLLECTED', 'COMPLETED', 'CANCELLED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "LabPackageGender" AS ENUM ('MALE', 'FEMALE', 'OTHER', 'ALL');
...
-- CreateEnum
CREATE TYPE "ConsultationType" AS ENUM ('LAB_VISIT', 'SAMPLE_COLLECTION');
...
CREATE TABLE "LabAddress" (
    ...
    CONSTRAINT "LabAddress_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "LabReport" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "summary" TEXT,
    "reportStatus" "LabReportStatus" NOT NULL,
    "reportUrls" TEXT[],
    "collectedAt" TIMESTAMP(3),
...
CREATE TABLE "LabCart" (
    ...
    "consultationType" "ConsultationType" NOT NULL DEFAULT 'LAB_VISIT',
    "patientProfileId" INTEGER,
...
CREATE TABLE "LabPackage" (
    ...
    "minage" INTEGER,
    "maxage" INTEGER,
    "gender" "LabPackageGender" NOT NULL DEFAULT 'MALE',
...
-- CreateIndex
CREATE UNIQUE INDEX "LabTest_labId_categoryId_name_key" ON "LabTest"("labId", "categoryId", "name");       

-- CreateIndex
CREATE INDEX "LabAddress_userId_idx" ON "LabAddress"("userId");

-- CreateIndex
CREATE INDEX "LabSlot_labId_slotDate_idx" ON "LabSlot"("labId", "slotDate");

-- CreateIndex
CREATE UNIQUE INDEX "LabSlot_labId_slotDate_startTime_key" ON "LabSlot"("labId", "slotDate", "startTime"); 

-- CreateIndex
CREATE INDEX "LabBooking_userId_idx" ON "LabBooking"("userId");

-- CreateIndex
CREATE INDEX "LabBooking_labId_idx" ON "LabBooking"("labId");

-- CreateIndex
CREATE INDEX "LabBooking_slotId_idx" ON "LabBooking"("slotId");
...
-- CreateIndex
CREATE UNIQUE INDEX "LabCart_user_lab_labTest_unique" ON "LabCart"("userId", "labId", "labTestId");        

-- CreateIndex
CREATE INDEX "LabPrescription_groupId_idx" ON "LabPrescription"("groupId");

-- CreateIndex
CREATE INDEX "Reminder_userId_reminderAt_idx" ON "Reminder"("userId", "reminderAt");

-- CreateIndex
CREATE INDEX "LabPackage_labId_idx" ON "LabPackage"("labId");

-- CreateIndex
CREATE INDEX "LabPackage_gender_idx" ON "LabPackage"("gender");

-- CreateIndex
CREATE UNIQUE INDEX "LabPackageItem_packageId_labTestId_key" ON "LabPackageItem"("packageId", "labTestId");
...
-- AddForeignKey
ALTER TABLE "LabAddress" ADD CONSTRAINT "LabAddress_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LabSlot" ADD CONSTRAINT "LabSlot_labId_fkey" FOREIGN KEY ("labId") REFERENCES "Lab"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LabBooking" ADD CONSTRAINT "LabBooking_patientProfileId_fkey" FOREIGN KEY ("patientProfileId") REFERENCES "PatientProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LabBooking" ADD CONSTRAINT "LabBooking_slotId_fkey" FOREIGN KEY ("slotId") REFERENCES "LabSlot"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LabCart" ADD CONSTRAINT "LabCart_patientProfileId_fkey" FOREIGN KEY ("patientProfileId") REFERENCES "PatientProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LabPackage" ADD CONSTRAINT "LabPackage_labId_fkey" FOREIGN KEY ("labId") REFERENCES "Lab"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LabPackageItem" ADD CONSTRAINT "LabPackageItem_labTestId_fkey" FOREIGN KEY ("labTestId") REFERENCES "LabTest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LabPackageItem" ADD CONSTRAINT "LabPackageItem_packageId_fkey" FOREIGN KEY ("packageId") REFERENCES "LabPackage"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
